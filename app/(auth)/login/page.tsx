      ...
      >
        ...
        {isConsultant && (
          <motion.div
            ...
            className="mb-6 p-4 bg-ClearGo-gold/10 border border-ClearGo-gold/30 rounded-xl text-center"
          >
            <div className="flex items-center justify-center gap-2 text-ClearGo-gold mb-2">
        ...
        <Card className="bg-white/5 backdrop-blur-xl border-white/10">
          <CardHeader className="text-center pb-2">
            <div className={`mx-auto w-12 h-12 rounded-full flex items-center justify-center mb-4 ${isConsultant ? 'bg-ClearGo-gold/20' : 'bg-blue-500/20'}`}>
              {isConsultant ? (
                <Briefcase className="w-6 h-6 text-ClearGo-gold" />
              ) : (
            ...
            <CardDescription className="text-gray-400">
              {isConsultant 
                ? "Accédez à votre espace consultant ClearGo"
          ...
          <CardContent className="pt-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder={isConsultant ? "consultant@cleargo.fr" : "vous@entreprise.com"}
                    value={email}
              ...
              <div className="text-right">
                <Link href="/forgot-password" className="text-sm text-ClearGo-gold hover:underline">
                  Mot de passe oublié ?
                </Link>
              </div>
            ...
            <div className="mt-6 space-y-3 text-center">
              {!isConsultant && (
                <p className="text-gray-400 text-sm">
                  ...
                  <Link href="/signup" className="text-ClearGo-gold hover:underline">
                    Créer un compte
                  </Link>
                </p>
              )}
              ...
              {isConsultant ? (
                ...
                <p className="text-gray-400 text-sm">
                  ...
                  <Link href="/login?role=consultant" className="text-ClearGo-gold hover:underline">
                    Espace consultant
                  </Link>
                </p>
              )}
