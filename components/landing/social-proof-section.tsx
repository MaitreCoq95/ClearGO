...
function CaseStudyCard({ study }: { study: CaseStudy }) {
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-ClearGo-gold/30 transition-all group">
      {/* Header */}
      <div className="bg-gradient-to-r from-ClearGo-gold/10 to-transparent p-6">
      ...
      <div className="grid grid-cols-2 gap-4 p-6 border-b border-white/5">
        {study.results.map((result, i) => (
          <div key={i} className="text-center">
            <p className="text-2xl font-bold text-ClearGo-gold">{result.value}</p>
      ...
      <div className="p-6">
        <div className="relative">
          <Quote className="w-8 h-8 text-ClearGo-gold/20 absolute -top-2 -left-2" />
          <p className="text-gray-300 text-sm italic relative z-10 pl-4">
            &quot;{study.testimonial.quote}&quot;
          </p>
        </div>
        <div className="flex items-center gap-3 mt-4">
          <div className="w-10 h-10 rounded-full bg-ClearGo-gold/20 flex items-center justify-center text-ClearGo-gold font-bold">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
            <span className="text-ClearGo-gold">100+</span> entreprises accompagnées vers la conformité
          </h2>
          <p className="text-lg text-gray-400">
            Découvrez comment nos clients ont transformé leur système qualité 
            et obtenu leurs certifications avec ClearGo.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mb-16">
          {[
            ...
            <div key={i} className="text-center p-4 bg-white/5 rounded-xl border border-white/10">
              <p className="text-2xl md:text-3xl font-bold text-ClearGo-gold">{stat.value}</p>
