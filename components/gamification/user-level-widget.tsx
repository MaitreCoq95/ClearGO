...
export function UserLevelWidget() {
  ...
  return (
    <Card className="bento-card border-ClearGo-gold/20 relative overflow-hidden">
      <div className="absolute top-0 right-0 p-20 bg-ClearGo-gold/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      ...
      <CardContent className="flex items-center gap-8">
        ...
        <div className="relative w-32 h-32 flex-shrink-0">
          <svg className="w-full h-full -rotate-90 transform">
            ...
            <circle
              ...
              strokeLinecap="round"
              className="text-ClearGo-gold transition-all duration-1000 ease-out"
            />
          </svg>
        ...
        <div className="space-y-3 flex-1">
          <div>
            ...
            <div className="text-2xl font-bold bg-gradient-to-r from-ClearGo-gold to-amber-500 bg-clip-text text-transparent">
              {progress.rank}
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="h-2 bg-secondary rounded-full overflow-hidden">
              <div 
                className="h-full bg-gradient-to-r from-ClearGo-navy to-ClearGo-gold" 
